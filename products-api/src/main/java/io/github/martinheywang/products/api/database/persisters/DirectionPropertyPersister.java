...
public class DirectionPropertyPersister extends BaseDataType {
    ...
    private DirectionPropertyPersister() {
        super(SqlType.STRING, new Class<?>[] { SimpleDirectionProperty.class });
    }

    @Override
    public SimpleDirectionProperty parseDefaultString(FieldType fieldType, String defaultStr) throws SQLException {
        return new SimpleDirectionProperty(Direction.UP);
    }
    ...
    @Override
    public SimpleDirectionProperty sqlArgToJava(FieldType fieldType, Object sqlArg, int columnPos) {
        return new SimpleDirectionProperty(Direction.valueOf((String) sqlArg));
    }

    @Override
    public String javaToSqlArg(FieldType fieldType, Object obj){
        return ((SimpleDirectionProperty) obj).get().toString();
    }
     ...
     */
    public static DirectionPropertyPersister getInstance() {
        return instance;
    }
