...
public class DeviceModel {
	...
	return "/images/" + this.getLevel().getURL() + this.getType().getSimpleName().toUpperCase() + ".png";
    }
	...
	return "/images/" + this.getLevel().getNext().getURL() + this.getType().getSimpleName().toUpperCase() + ".png";
    }

    @Override
    public String toString() {
	return "{" + this.clazz.getSimpleName() + ", " + this.level + ", " + this.direction + ", " + this.game + ", " + this.position + "}";
    }
