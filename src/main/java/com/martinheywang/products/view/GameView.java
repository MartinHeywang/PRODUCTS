...
import com.martinheywang.products.view.component.DeviceView;
import com.martinheywang.products.view.component.ZoomableScrollPane;
...
public class GameView implements Initializable {
     ...
     * 
     * @see GameView#toast(String, Color, double)
     */
    @FXML
    private VBox toasts;
	...
	try {
	    ...
	    final ResourceBundle gridBundle = ResourceBundle
		    .getBundle("com.martinheywang.products.model.bundle.GrilleUpdate");
	...
	try {
	    ...
	    final ResourceBundle loopBundle = ResourceBundle
		    .getBundle("com.martinheywang.products.model.bundle.GameLoopUpdate");
	...
	try {
	    ...
	    final ResourceBundle maxBundle = ResourceBundle
		    .getBundle("com.martinheywang.products.model.bundle.MaxBuyerUpdate");
	...
	Platform.runLater(() -> {
	    ...
	    GameView.this.toasts.getChildren().add(toast);
	    ...
	    animation.setOnFinished((arg0) -> GameView.this.toasts.getChildren().remove(toast));
	...
	final ResourceBundle bundle = ResourceBundle.getBundle("com.martinheywang.products.model.bundle.GrilleUpdate");
