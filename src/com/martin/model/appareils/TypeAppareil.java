...
public enum TypeAppareil {
	...
	*/
	...
	TypeAppareil(String nom, String url, String desc, int prix, Class<? extends Appareil> classe){
		this.nom = nom;
		this.url = url;
		this.desc = desc;
		this.classe = classe;
