...
public final class DeviceController {
	...
	public DeviceController(Game game) throws LoadException {
		...
		try {
			devicesModels = Database.createDao(DeviceModel.class).queryForEq("game_id", game.getID());
	...
	public void replace(Class<? extends Device> clazz, Level level, Direction direction, Coordinate position) {
		...
		final DeviceModel newModel = new DeviceModel(clazz, level, direction, this.game, position);
